...
Using `manage.create` with threatware as an API, to create a new threat model ID for a threat model document in Confluence:

    https://<api-hostname>/manage/create?IDprefix=CMP.TMD&scheme=confluence_1.0&docloc=123456
...
Using `manage.submit` with threatware as an API, to submit a threat model for approval, for a threat model document in Confluence:

    https://<api-hostname>/manage/submit?scheme=confluence_1.0&docloc=123456
...
Using `manage.check` with threatware as an API, to submit a threat model for a re-approval check, for a threat model document in Confluence:

    https://<api-hostname>/manage/check?scheme=confluence_1.0&docloc=123456
...
Using `manage.indexdata` with threatware as an API, to request index metadata for a threat model document:

    https://<api-hostname>/manage/indexdata?id=CMP.TMD.4
